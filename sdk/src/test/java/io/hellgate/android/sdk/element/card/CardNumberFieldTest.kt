...
class CardNumberFieldTest : ComposeRoboTest() {
    @Test
    fun `Type in valid Visa Card number, Returns correct states and value`() =
        runTest {
    ...
    @Test
    fun `Type in valid Amex Card number, Returns correct states and value`() =
        runTest {
            val cardNumberField = CardNumberField()
            var cardNumberFieldState: FieldState? = null
            var onFocusedCount = 0
    ...
    @Test
    fun `Type in invalid Card starting with 1, No further inputs are accepted and field shows error`() =
        runTest {
            val cardNumberField = CardNumberField()
            var cardNumberFieldState: FieldState? = null
            var onFocusedCount = 0
    ...
    @Test
    fun `Set field label manual to specific value, Field is drawn with specified value`() =
        runTest {
