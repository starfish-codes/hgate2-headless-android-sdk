...
class CardHandlerKtTest {
    @Test
    fun `TokenizeCard, Receive valid input, Returns expected result`() = runTest {
    ...
    @Test
    fun `TokenizeCard, Receive invalid card number, Returns Failure with error and message about card`() = runTest {
        val sessionID = "sessionID"
        val cardMockk = mockk<CardNumberField> {
    ...
    @Test
    fun `TokenizeCard, Receive invalid fields, Returns Failure with errors and concatinated message`() = runTest {
        val sessionID = "sessionID"
        val cardMockk = mockk<CardNumberField> {
            coEvery { validatedValue() } returns null
        }
