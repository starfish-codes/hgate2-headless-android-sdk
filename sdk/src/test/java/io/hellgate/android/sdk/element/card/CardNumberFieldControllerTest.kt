...
class CardNumberFieldControllerTest {
    ...
    class ImpliedCardBrand {
        @Test
        fun `Input values into textField, impliedBrand Returns null`() = runTest {
            val controller = CardNumberFieldController()
        ...
        @Test
        fun `Input values into textField, impliedBrand Returns visa`() = runTest {
            val controller = CardNumberFieldController()
    ...
    class TrailingIcon {
        @Test
        fun `Get trailing icon for Visa card, Returns visa icon res id`() = runTest {
            val controller = CardNumberFieldController()
        ...
        @Test
        fun `Get trailing icon for error input, Returns error icon res id`() = runTest {
            val controller = CardNumberFieldController()
    ...
    class GetCardNumber {
        @Test
        fun `Get card number for Visa card, Returns card number`() = runTest {
            val controller = CardNumberFieldController()
        ...
        @Test
        fun `Get card number for invalid card number, Returns null`() = runTest {
            val controller = CardNumberFieldController()
    ...
    class FieldStateTest {
        @Test
        fun `Get field state for Visa card, Returns valid state`() = runTest {
            val controller = CardNumberFieldController()
        ...
        @Test
        fun `Get field state for invalid card number, Returns error state`() = runTest {
            val controller = CardNumberFieldController()
        ...
        @Test
        fun `Get field state for blank card number, Returns blank state`() = runTest {
            val controller = CardNumberFieldController()
