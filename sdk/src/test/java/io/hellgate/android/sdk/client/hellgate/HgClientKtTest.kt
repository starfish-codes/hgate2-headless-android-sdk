...
class HgClientKtTest {
    class FetchSession : WiremockTest() {
        @Test
        fun `Try to fetch an existing session with correct id, Returns BT Api Key`() = runTest {
        ...
        @Test
        fun `Try to fetch a non-existing session with incorrect id, Returns correct status and client error`() = runTest {
    ...
    class CompleteTokenizeCard : WiremockTest() {
        @Test
        fun `Try to complete a session with correct id and BT Token Id, Returns Token Id`() = runTest {
        ...
        @Test
        fun `Try to complete a session with correct id and BT Token Id and addData, Returns Token Id`() = runTest {
        ...
        @Test
        fun `Try to complete a session with incorrect id and BT Token Id, Returns correct status and client error`() = runTest {
